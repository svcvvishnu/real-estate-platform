        ...
        <form action={handleSubmit} className="space-y-6 bg-white p-6 rounded-lg shadow">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div className="sm:col-span-2">
                    ...
                    <input type="text" name="title" required minLength={5} className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" placeholder="e.g. 3BHK Apartment in City Center" />
                    <p className="mt-1 text-xs text-gray-400">Minimum 5 characters required.</p>
                </div>

                <div className="sm:col-span-2">
                    <label className="block text-sm font-medium text-gray-700">Description</label>
                    <textarea name="description" rows={3} required minLength={10} className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" placeholder="Describe the property..."></textarea>
                    <p className="mt-1 text-xs text-gray-400">Minimum 10 characters required.</p>
                </div>

                <div>
                    <label className="block text-sm font-medium text-gray-700">Price (₹)</label>
                    <input type="number" name="price" required min={1} className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" />
                ...
                <div>
                    ...
                    <input type="number" name="area" required min={0.01} step="0.01" className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" />
                    <p className="mt-1 text-xs text-gray-400">Must be a positive value.</p>
                </div>
                ...
                <div className="sm:col-span-2">
                    ...
                    <input type="text" name="address" required minLength={5} className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" placeholder="Full address" />
                    <p className="mt-1 text-xs text-gray-400">Minimum 5 characters required.</p>
                </div>
